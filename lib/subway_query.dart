...
//          print(target.toString() + "!!!!");
        if (target == "subway_4_upper") {
          ...
          if(subwayList['realtimeArrivalList'][0]['arvlMsg3'] == "한대앞" || subwayList['realtimeArrivalList'][0]['arvlMsg3'] == "중앙"){
            //전역도착, 한대앞 도착, 한대앞 진입, 전역 진입 의 경우에는 그냥 출력
            parsedData["arvlMsg2"] =
            subwayList['realtimeArrivalList'][0]['arvlMsg2']; //[1]전역 상록수
          } else {
            //그밖의 경우에는 [3]번째 전역 (초지)형식을 다듬어서 리턴.
            parsedData["arvlMsg2"] = parseString(subwayList['realtimeArrivalList'][0]['arvlMsg2'], subwayList['realtimeArrivalList'][0]['arvlMsg3']);
          }
        }
        ...
        if (target == "subway_4_lower") {
          ...
          if(subwayList['realtimeArrivalList'][2]['arvlMsg3'] == "한대앞" || subwayList['realtimeArrivalList'][2]['arvlMsg3'] == "상록수"){
            //전역도착, 한대앞 도착, 한대앞 진입, 전역 진입 의 경우에는 그냥 출력
            parsedData["arvlMsg2"] =
            subwayList['realtimeArrivalList'][2]['arvlMsg2']; //[1]전역 상록수
          } else {
            //그밖의 경우에는 [3]번째 전역 (초지)형식을 다듬어서 리턴.
            parsedData["arvlMsg2"] = parseString(subwayList['realtimeArrivalList'][2]['arvlMsg2'], subwayList['realtimeArrivalList'][2]['arvlMsg3']);
          }
        }
      } else {
...
parseString(arvlMsg2, arvlMsg3) {//arrvlMsg2 = [3]번째 전역 (초지), arvlMsg2 = 초지 형식.
